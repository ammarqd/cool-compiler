...
public class CoolLexer extends Lexer {
	...
	public static final int
		...
		IF=23, THEN=24, ELSE=25, FI=26, WHILE=27, LOOP=28, POOL=29, LET=30, IN=31, 
		CASE=32, OF=33, ESAC=34, NEW=35, ISVOID=36, TRUE=37, FALSE=38, TYPEID=39, 
		OBJECTID=40, WHITESPACE=41, INT_CONST=42, STR_CONST=43, LINE_COMMENT=44, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"OF", "ESAC", "NEW", "ISVOID", "TRUE", "FALSE", "TYPEID", "OBJECTID", 
